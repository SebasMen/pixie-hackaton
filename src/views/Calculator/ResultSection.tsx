  ...
  return (
    <div className='w-full rounded-t-3xl bg-sixth -mt-5 z-10 animate__animated animate__fadeIn md:px-20 xl1:px-[12.8rem] xl2:px-[17.8rem]'>
      <div className='mb-8 mt-14 text-center px-9 md:px-0'>
        <span className='text-primary text-xl font-bold lg:text-[24px]'>¡PIXEL debe consumir un total de 670 gramos al día en 2 porciones!</span>
      </div>
      <span className='ml-3 px-3 md:px-0'>Recomendados:</span>

      {/* Carrousel */}
      <Carrousel className='pt-10 pb-10 lg:px-[9rem]' onSlideChange={setSelected} navigation breakpoints={{
        100: {
          slidesPerView: 1,
          spaceBetween: 0,
          initialSlide: 2,
      ...
      <div className='text-center mt-8 mb-5 font-subTitles font-bold'>
        <span>Dieta recomendada para 4 semanas = 30 rollitos, <span className='text-primary'>¡combínalas como tu quieras!</span></span>
      </div>
