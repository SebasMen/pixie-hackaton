...
const ResultRecommendation = () => (
  <div className='flex flex-col gap-10 w-full my-16 px-64'>
    <div className='flex flex-col gap-5'>
      <RecomendationItem name={'Carne al horno'} price={322.620} quantity={30} />
      <RecomendationItem name={'Carne al horno'} price={322.620} quantity={30} />
    </div>
    <div className='flex flex-shrink-0 justify-center items-center gap-5 w-full h-32 p-10 rounded-2xl shadow-xl ring-1 ring-red-500'>
      <div className='flex items-center justify-center w-1/6 h-full border-r border-r-red-500'>
      ...
      <div className='w-1/5 flex flex-shrink-0 justify-between items-center text-red-500'>
