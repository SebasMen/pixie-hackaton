...
export const CalculatorSection = () => {
  ...
  return (
    <div className='relative flex flex-col h-full pt-11 w-full items-center justify-center text-center rounded-t-3xl overflow-hidden transform -mt-4 z-10 md:flex-row-reverse bg-secondaryOpacity'>
      <img src={fillets} className='object-cover h-full w-full float-none absolute' />
      <div className='flex flex-col items-center justify-center md:w-1/3 z-10 max-w-[1440px]'>
