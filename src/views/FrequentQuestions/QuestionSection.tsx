...
const QuestionSection = () => {
  ...
  return (
    <div className='flex flex-col text-left w-full px-6 mt-3 md:px-36 mb-36 md:mt-[6.35rem]'>
      <h1 className='text-pixieLightBlue text-2xl text-left md:text-[30px]'>Preguntas frecuentes</h1>
      <ul className='mt-10 flex flex-col gap-8 md:gap-[2.7rem]'>
        ...
        <AccordeonList title={t('q2Text')}>
          <div className='flex flex-col gap-5'>
            ...
            <span>
              {t('q2AnswerFrag5')}
              <a className='underline cursor-pointer' onClick={() => navigate('/calculadora')}>
                {t('q2AnswerFrag6')}
              </a>
            </span>
          </div>
