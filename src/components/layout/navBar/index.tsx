...
export const NavBar = () => {
  ...
  return (
    <div className='w-full relative'>
      ...
      <div className='flex justify-between w-full p-5 overflow-hidden md:justify-start md:gap-10 lg:px-20 '>
        {/* Menu Toggle */}
        <div className={`flex-shrink-0 md:hidden text-${color}`}>
          <IconButton name='menu' size='3xl' shadow={false} onClick={toggleCollapsed} className='pt-3' />
        </div>

        {/* Logo */}
        <div className='w-16 flex-shrink-0 flex justify-center items-center md:w-[6.75rem] md:justify-start'>
