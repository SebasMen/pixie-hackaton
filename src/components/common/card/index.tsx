    ...
    className={`
        ...
        ${
          selected
            ? 'bg-[#d7e7de]'
            : far
            ? 'bg-pixieGreen scale-50 xl1:scale-[0.55] xl2:scale-x-[0.668] xl2:scale-y-[0.67]'
            : 'bg-pixieGreenSemiOpacity scale-75 xl1:scale-[0.8] xl2:scale-[0.83]'
        }
        ${className}
    `}
  >
    <div className='flex flex-grow flex-shrink-0 items-center justify-center'>
      {selected ? (
        ...
        <img
          src={selected ? imgselected : img}
          className={`${
            selected
              ? 'w-[138px] h-[138px] xl:w-48 xl:h-48'
              : far
              ? 'w-[138px] h-[138px] xl:w-36 xl:h-36'
              : 'w-[138px] h-[138px] xl:w-36 xl:h-36'
          }`}
        />
      )}
